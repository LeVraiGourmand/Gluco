...
/*                                                                                   */
/*      Date: Wed May 01 10:52:50 CEST 2024                                          */
...
// Payloads de streaming et d'activation[cite: 20, 22, 24]
const unsigned char getStreamingPayload[] = {0x1e, 'Z', 0xfc, 0x29, 0x15, 'c', 0x9e, 'A', 's'};
const unsigned char getStreamingUnlockPayload[] = {0xce, 0xbd, 0x24, 0x15, 0x7, 0xcd, 0xa9, 0xdf, 0xca, 0xc, '1', 'J', 0};
const unsigned char getActivationPayload[] = {0x1b, 0xa0, 0x14, 'O', 0x2c};

extern Sensoren *sensors;
extern jint parsertype;
using namespace std;

struct VISIBLE scandata : public nfcdata {
    bool error = false;
    data_t *data, *info;
...
public:
    ...
    const data_t *getident() const { return hist->getsensorident(); }
    const data_t *getinfo() const { return hist->getpatchinfo(); }
    ...
    bool good() const override { return state && state->good(); }
